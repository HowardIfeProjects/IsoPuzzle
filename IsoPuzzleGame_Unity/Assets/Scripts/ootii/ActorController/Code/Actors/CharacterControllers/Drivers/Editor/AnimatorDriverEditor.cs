...
public class AnimatorDriverEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorHelper.DrawInspectorTitle("ootii Animator Driver");

        EditorHelper.DrawInspectorDescription("Actor driver that takes input and uses information from the Mecanim Animator to tell the Actor Controller what to do.", MessageType.None);
