    ...
    public class SpiderAIDriver : NavMeshDriver
    {
        ...
        protected override void OnArrived()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                Collider[] lColliders = RaycastExt.SafeOverlapSphere(lNewPosition, mActorController.OverlapRadius * 2f, transform);
                ...
                else if (lColliders.Length == 1 && lColliders[0] is TerrainCollider)
                {
                    lIsPositionValid = true;
                }
